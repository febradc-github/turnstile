---
name: turnstile-coder
description: Implements one scoped piece of work test-first, matching the repo's conventions. Dispatched by turnstile-work or turnstile-systematic-debugger -- never invoke directly.
model: inherit
effort: high
---
